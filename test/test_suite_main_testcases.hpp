...
PRINTF_TEST_CASE(space_flag)
{
    ...
    PRINTING_CHECK("        -42.987", ==, sprintf_, buffer, "% 15.3f",
                   F16(-42.987));
    PRINTING_CHECK("         42.987", ==, sprintf_, buffer, "% 15.3f",
                   F16(42.987));
#endif
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("Hello testing", ==, sprintf_, buffer, "% s",
                   mkstr("Hello testing"));
...
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("4294966272", ==, sprintf_, buffer, "% I32u",
                   (uint32_t)4294966272U);
    PRINTING_CHECK("4294966272", ==, sprintf_, buffer, "% I64u",
                   (uint64_t)4294966272U);
#endif
...
PRINTF_TEST_CASE(specifier)
{
    ...
    PRINTING_CHECK("2147483647", ==, sprintf_, buffer, "%I32d",
                   (int32_t)2147483647LL);
#if (LLONG_MAX >= 9223372036854775807LL)
    PRINTING_CHECK("9223372036854775807", ==, sprintf_, buffer, "%I64d",
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("Hello testing", ==, sprintf_, buffer, "%1s",
                   mkstr("Hello testing"));
...
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("4294966272", ==, sprintf_, buffer, "%1I32u",
                   (uint32_t)4294966272U);
    PRINTING_CHECK("4294966272", ==, sprintf_, buffer, "%1I64u",
                   (uint64_t)4294966272U);
#endif
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("               Hello", ==, sprintf_, buffer, "%20s",
                   mkstr("Hello"));
...
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20I16u",
                   (uint16_t)1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20I32u",
                   (uint32_t)1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20I64u",
                   (uint64_t)1024);
#endif
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%20u",
                   4294966272U);
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%20I32u",
                   (uint32_t)4294966272U);
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%20I64u",
                   (uint64_t)4294966272U);
#endif
    PRINTING_CHECK("                 777", ==, sprintf_, buffer, "%20o", 511);
    PRINTING_CHECK("         37777777001", ==, sprintf_, buffer, "%20o",
                   4294966785U);
    PRINTING_CHECK("            1234abcd", ==, sprintf_, buffer, "%20x",
                   305441741);
    PRINTING_CHECK("            edcb5433", ==, sprintf_, buffer, "%20x",
                   3989525555U);
    PRINTING_CHECK("            1234ABCD", ==, sprintf_, buffer, "%20X",
                   305441741);
    PRINTING_CHECK("            EDCB5433", ==, sprintf_, buffer, "%20X",
...
#if PRINTF_SUPPORT_LONG_LONG
    PRINTING_CHECK("                   0", ==, sprintf_, buffer, "%20llX",
                   0ULL);
#endif
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("               Hello", ==, sprintf_, buffer, "%*s", 20,
                   mkstr("Hello"));
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*d", 20,
                   1024);
    PRINTING_CHECK("               -1024", ==, sprintf_, buffer, "%*d", 20,
                   -1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*i", 20,
                   1024);
    PRINTING_CHECK("               -1024", ==, sprintf_, buffer, "%*i", 20,
                   -1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*u", 20,
                   1024);
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*I16u", 20,
                   (uint16_t)1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*I32u", 20,
                   (uint32_t)1024);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%*I64u", 20,
                   (uint64_t)1024);
#endif
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%*u", 20,
                   4294966272U);
#ifdef PRINTF_SUPPORT_MSVC_STYLE_INTEGER_SPECIFIERS
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%*I32u", 20,
                   (uint32_t)4294966272U);
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%*I64u", 20,
                   (uint64_t)4294966272U);
#endif
    PRINTING_CHECK("                 777", ==, sprintf_, buffer, "%*o", 20,
                   511);
    PRINTING_CHECK("         37777777001", ==, sprintf_, buffer, "%*o", 20,
                   4294966785U);
    PRINTING_CHECK("            1234abcd", ==, sprintf_, buffer, "%*x", 20,
                   305441741);
    PRINTING_CHECK("            edcb5433", ==, sprintf_, buffer, "%*x", 20,
                   3989525555U);
    PRINTING_CHECK("            1234ABCD", ==, sprintf_, buffer, "%*X", 20,
                   305441741);
    PRINTING_CHECK("            EDCB5433", ==, sprintf_, buffer, "%*X", 20,
                   3989525555U);
    PRINTING_CHECK("                   x", ==, sprintf_, buffer, "%*c", 20,
                   'x');
}
...
PRINTF_TEST_CASE(width_minus_20)
{
    ...
    PRINTING_CHECK("Hello               ", ==, sprintf_, buffer, "%-20s",
                   mkstr("Hello"));
    PRINTING_CHECK("1024                ", ==, sprintf_, buffer, "%-20d", 1024);
    PRINTING_CHECK("-1024               ", ==, sprintf_, buffer, "%-20d",
                   -1024);
    PRINTING_CHECK("1024                ", ==, sprintf_, buffer, "%-20i", 1024);
    ...
    PRINTING_CHECK("EDCB5433            ", ==, sprintf_, buffer, "%-20X",
                   3989525555U);
    PRINTING_CHECK("x                   ", ==, sprintf_, buffer, "%-20c", 'x');
    PRINTING_CHECK("|    9| |9 | |    9|", ==, sprintf_, buffer,
                   "|%5d| |%-2d| |%5d|", 9, 9, 9);
    PRINTING_CHECK("|   10| |10| |   10|", ==, sprintf_, buffer,
                   "|%5d| |%-2d| |%5d|", 10, 10, 10);
    PRINTING_CHECK("|    9| |9           | |    9|", ==, sprintf_, buffer,
                   "|%5d| |%-12d| |%5d|", 9, 9, 9);
    PRINTING_CHECK("|   10| |10          | |   10|", ==, sprintf_, buffer,
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("Hello               ", ==, sprintf_, buffer, "%0-20s",
                   mkstr("Hello"));
    PRINTING_CHECK("1024                ", ==, sprintf_, buffer, "%0-20d",
                   1024);
    PRINTING_CHECK("-1024               ", ==, sprintf_, buffer, "%0-20d",
                   -1024);
    PRINTING_CHECK("1024                ", ==, sprintf_, buffer, "%0-20i",
                   1024);
    PRINTING_CHECK("-1024               ", ==, sprintf_, buffer, "%0-20i",
                   -1024);
    PRINTING_CHECK("1024                ", ==, sprintf_, buffer, "%0-20u",
                   1024);
    PRINTING_CHECK("4294966272          ", ==, sprintf_, buffer, "%0-20u",
                   4294966272U);
    PRINTING_CHECK("777                 ", ==, sprintf_, buffer, "%0-20o", 511);
    PRINTING_CHECK("37777777001         ", ==, sprintf_, buffer, "%0-20o",
                   4294966785U);
    PRINTING_CHECK("1234abcd            ", ==, sprintf_, buffer, "%0-20x",
                   305441741);
    PRINTING_CHECK("edcb5433            ", ==, sprintf_, buffer, "%0-20x",
                   3989525555U);
    PRINTING_CHECK("1234ABCD            ", ==, sprintf_, buffer, "%0-20X",
                   305441741);
    PRINTING_CHECK("EDCB5433            ", ==, sprintf_, buffer, "%0-20X",
...
PRINTF_TEST_CASE(padding_20)
{
    ...
    PRINTING_CHECK("-0000000000000001024", ==, sprintf_, buffer, "%020d",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%020i", 1024);
    PRINTING_CHECK("-0000000000000001024", ==, sprintf_, buffer, "%020i",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%020u", 1024);
    PRINTING_CHECK("00000000004294966272", ==, sprintf_, buffer, "%020u",
                   4294966272U);
    PRINTING_CHECK("00000000000000000777", ==, sprintf_, buffer, "%020o", 511);
    PRINTING_CHECK("00000000037777777001", ==, sprintf_, buffer, "%020o",
                   4294966785U);
    PRINTING_CHECK("0000000000001234abcd", ==, sprintf_, buffer, "%020x",
                   305441741);
    PRINTING_CHECK("000000000000edcb5433", ==, sprintf_, buffer, "%020x",
                   3989525555U);
    PRINTING_CHECK("0000000000001234ABCD", ==, sprintf_, buffer, "%020X",
                   305441741);
    PRINTING_CHECK("000000000000EDCB5433", ==, sprintf_, buffer, "%020X",
...
PRINTF_TEST_CASE(padding_dot_20)
{
    ...
    PRINTING_CHECK("-00000000000000001024", ==, sprintf_, buffer, "%.20d",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%.20i", 1024);
    PRINTING_CHECK("-00000000000000001024", ==, sprintf_, buffer, "%.20i",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%.20u", 1024);
    PRINTING_CHECK("00000000004294966272", ==, sprintf_, buffer, "%.20u",
                   4294966272U);
    PRINTING_CHECK("00000000000000000777", ==, sprintf_, buffer, "%.20o", 511);
    PRINTING_CHECK("00000000037777777001", ==, sprintf_, buffer, "%.20o",
                   4294966785U);
    PRINTING_CHECK("0000000000001234abcd", ==, sprintf_, buffer, "%.20x",
                   305441741);
    PRINTING_CHECK("000000000000edcb5433", ==, sprintf_, buffer, "%.20x",
                   3989525555U);
    PRINTING_CHECK("0000000000001234ABCD", ==, sprintf_, buffer, "%.20X",
                   305441741);
    PRINTING_CHECK("000000000000EDCB5433", ==, sprintf_, buffer, "%.20X",
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%#020d",
                   1024);
    PRINTING_CHECK("-0000000000000001024", ==, sprintf_, buffer, "%#020d",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%#020i",
                   1024);
    PRINTING_CHECK("-0000000000000001024", ==, sprintf_, buffer, "%#020i",
                   -1024);
    PRINTING_CHECK("00000000000000001024", ==, sprintf_, buffer, "%#020u",
                   1024);
    PRINTING_CHECK("00000000004294966272", ==, sprintf_, buffer, "%#020u",
                   4294966272U);
}
...
PRINTF_TEST_CASE(padding_sharp_020)
{
    ...
    PRINTING_CHECK("00000000037777777001", ==, sprintf_, buffer, "%#020o",
                   4294966785U);
    PRINTING_CHECK("0x00000000001234abcd", ==, sprintf_, buffer, "%#020x",
                   305441741);
    PRINTING_CHECK("0x0000000000edcb5433", ==, sprintf_, buffer, "%#020x",
                   3989525555U);
    PRINTING_CHECK("0X00000000001234ABCD", ==, sprintf_, buffer, "%#020X",
                   305441741);
    PRINTING_CHECK("0X0000000000EDCB5433", ==, sprintf_, buffer, "%#020X",
...
PRINTF_TEST_CASE(padding_sharp_20)
{
    ...
    PRINTING_CHECK("        037777777001", ==, sprintf_, buffer, "%#20o",
                   4294966785U);
    PRINTING_CHECK("          0x1234abcd", ==, sprintf_, buffer, "%#20x",
                   305441741);
    PRINTING_CHECK("          0xedcb5433", ==, sprintf_, buffer, "%#20x",
                   3989525555U);
    PRINTING_CHECK("          0X1234ABCD", ==, sprintf_, buffer, "%#20X",
                   305441741);
    PRINTING_CHECK("          0XEDCB5433", ==, sprintf_, buffer, "%#20X",
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("               01024", ==, sprintf_, buffer, "%20.5d",
                   1024);
    PRINTING_CHECK("              -01024", ==, sprintf_, buffer, "%20.5d",
                   -1024);
    PRINTING_CHECK("               01024", ==, sprintf_, buffer, "%20.5i",
                   1024);
    PRINTING_CHECK("              -01024", ==, sprintf_, buffer, "%20.5i",
                   -1024);
    PRINTING_CHECK("               01024", ==, sprintf_, buffer, "%20.5u",
                   1024);
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%20.5u",
                   4294966272U);
    PRINTING_CHECK("               00777", ==, sprintf_, buffer, "%20.5o", 511);
    PRINTING_CHECK("         37777777001", ==, sprintf_, buffer, "%20.5o",
                   4294966785U);
    PRINTING_CHECK("            1234abcd", ==, sprintf_, buffer, "%20.5x",
                   305441741);
    PRINTING_CHECK("          00edcb5433", ==, sprintf_, buffer, "%20.10x",
                   3989525555U);
    PRINTING_CHECK("            1234ABCD", ==, sprintf_, buffer, "%20.5X",
                   305441741);
    PRINTING_CHECK("          00EDCB5433", ==, sprintf_, buffer, "%20.10X",
...
PRINTF_TEST_CASE(length)
{
    ...
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.0s",
                   mkstr("Hello testing"));
    PRINTING_CHECK("", ==, sprintf_, buffer, "%.s", mkstr("Hello testing"));
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.s",
                   mkstr("Hello testing"));
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20.0d",
                   1024);
    PRINTING_CHECK("               -1024", ==, sprintf_, buffer, "%20.0d",
                   -1024);
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.d", 0);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20.0i",
                   1024);
    PRINTING_CHECK("               -1024", ==, sprintf_, buffer, "%20.i",
                   -1024);
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.i", 0);
    PRINTING_CHECK("                1024", ==, sprintf_, buffer, "%20.u", 1024);
    PRINTING_CHECK("          4294966272", ==, sprintf_, buffer, "%20.0u",
                   4294966272U);
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.u", 0U);
    PRINTING_CHECK("                 777", ==, sprintf_, buffer, "%20.o", 511);
    PRINTING_CHECK("         37777777001", ==, sprintf_, buffer, "%20.0o",
                   4294966785U);
    PRINTING_CHECK("                    ", ==, sprintf_, buffer, "%20.o", 0U);
    PRINTING_CHECK("            1234abcd", ==, sprintf_, buffer, "%20.x",
                   305441741);
    ...
    PRINTING_CHECK("            edcb5433", ==, sprintf_, buffer, "%20.0x",
                   3989525555U);
...
PRINTF_TEST_CASE(floating_point_specifiers_with_31_to_32_bit_integer_values)
{
    ...
    PRINTING_CHECK("2147483647", ==, sprintf_, buffer, "%.10f",
                   2147483647.0); // 2^31 - 1
    PRINTING_CHECK("2147483648", ==, sprintf_, buffer, "%.10f",
                   2147483648.0); // 2^31
    PRINTING_CHECK("4294967295", ==, sprintf_, buffer, "%.10f",
                   4294967295.0); // 2^32 - 1
    PRINTING_CHECK("4294967296", ==, sprintf_, buffer, "%.10f",
                   4294967296.0); // 2^32
#else
    PRINTING_CHECK("2.1474836470e+09", ==, sprintf_, buffer, "%.10f",
                   2147483647.0); // 2^31 - 1
    PRINTING_CHECK("2.1474836480e+09", ==, sprintf_, buffer, "%.10f",
                   2147483648.0); // 2^31
    PRINTING_CHECK("4.2949672950e+09", ==, sprintf_, buffer, "%.10f",
                   4294967295.0); // 2^32 - 1
    PRINTING_CHECK("4.2949672960e+09", ==, sprintf_, buffer, "%.10f",
                   4294967296.0); // 2^32
#endif
    PRINTING_CHECK("2147483647", ==, sprintf_, buffer, "%.10g",
                   2147483647.0); // 2^31 - 1
    PRINTING_CHECK("2147483648", ==, sprintf_, buffer, "%.10g",
                   2147483648.0); // 2^31
    PRINTING_CHECK("4294967295", ==, sprintf_, buffer, "%.10g",
                   4294967295.0); // 2^32 - 1
    PRINTING_CHECK("4294967296", ==, sprintf_, buffer, "%.10g",
                   4294967296.0); // 2^32
}
...
PRINTF_TEST_CASE(tiny_floating_point_values)
{
    ...
    PRINTING_CHECK("1.38065e-23", ==, sprintf_, buffer, "%.5e",
                   1.380651569e-23);
    PRINTING_CHECK("1.380652e-23", ==, sprintf_, buffer, "%.6e",
                   1.380651569e-23);
    PRINTING_CHECK("1.3806516e-23", ==, sprintf_, buffer, "%.7e",
                   1.380651569e-23);
    PRINTING_CHECK("1.38065157e-23", ==, sprintf_, buffer, "%.8e",
                   1.380651569e-23);
    PRINTING_CHECK("1.380651569e-23", ==, sprintf_, buffer, "%.9e",
                   1.380651569e-23);
    PRINTING_CHECK("1.3806515690e-23", ==, sprintf_, buffer, "%.10e",
                   1.380651569e-23);
    PRINTING_CHECK("1.38065156900e-23", ==, sprintf_, buffer, "%.11e",
                   1.380651569e-23);
    // These go beyond our precision abilities; enable them, and they will
    // likely fail.
    //  PRINTING_CHECK("1.380651569000e-23",    ==, sprintf_, buffer,
    //  "%.12e", 1.380651569e-23); PRINTING_CHECK("1.3806515690000e-23",   ==,
    //  sprintf_, buffer, "%.13e", 1.380651569e-23);
    //  PRINTING_CHECK("1.38065156900000e-23",  ==, sprintf_, buffer,
    //  "%.14e", 1.380651569e-23); PRINTING_CHECK("1.380651569000000e-23", ==,
    //  sprintf_, buffer, "%.15e", 1.380651569e-23);
    //  PRINTING_CHECK("1.3806515690000000e-23", ==, sprintf_, buffer,
    //  "%.16e", 1.380651569e-23);
}
...
PRINTF_TEST_CASE(fallback_from_decimal_to_exponential)
{
    ...
    CAPTURE_AND_PRINT(sprintf_, buffer, "%.0f",
                      (double)((int64_t)1 * 1000 * 1000 * 1000 * 1000));
    ...
    CAPTURE_AND_PRINT(sprintf_, buffer, "%.0f",
                      (double)((int64_t)1 * 1000 * 1000 * 1000 * 1000 * 1000));
...
PRINTF_TEST_CASE(floating_point_specifiers_precision_and_flags)
{
    ...
    PRINTING_CHECK("42.895223123457", ==, sprintf_, buffer, "%.12F",
                   42.89522312345678);
    /* %lf for double */
    PRINTING_CHECK("42.895223123457", ==, sprintf_, buffer, "%.12lf",
                   42.89522312345678);
    /* %Lf for long double */
    PRINTING_CHECK("42.895223123457", ==, sprintf_, buffer, "%.12Lf",
                   42.89522312345678l);
    ...
    PRINTING_CHECK("+001.234e-05", ==, sprintf_, buffer, "%+012.4g",
                   0.00001234);
    // Note: The following two values are _barely_ normal; make their
    // mantissa 1.1 and they lose their normality.
    ...
    PRINTING_CHECK("100.", ==, sprintf_, buffer, "%#.3g",
                   99.998580932617187500);
    PRINTING_CHECK("1.e01", ==, sprintf_, buffer, "%# 01.1g", 9.8);
    // Note: The following value is _barely_ normal; make the mantissa 1.1 and
    // it loses its normality.
    PRINTING_CHECK("1.2345678901e-308", ==, sprintf_, buffer, "%.10e",
                   1.2345678901e-308);
    ...
    PRINTING_CHECK("-8.380923438e+04", ==, sprintf_, buffer, "%.9e",
                   -83809.234375);
    ...
    PRINTING_CHECK("100.", ==, sprintf_, buffer, "%#.3G",
                   99.998580932617187500);
    /* %lg for double */
    PRINTING_CHECK("100.", ==, sprintf_, buffer, "%#.3lg",
                   99.998580932617187500);
    /* %Lg for long double */
    PRINTING_CHECK("100.", ==, sprintf_, buffer, "%#.3Lg",
                   99.998580932617187500l);
    PRINTING_CHECK("100.", ==, sprintf_, buffer, "%#.3Lg",
                   99.998580932617187500L);
    ...
    PRINTING_CHECK("-8.380923438E+04", ==, sprintf_, buffer, "%.9E",
                   -83809.234375);
    /* %le for double */
    PRINTING_CHECK("-8.380923438e+04", ==, sprintf_, buffer, "%.9le",
                   -83809.234375);
    /* %Le for long double */
    PRINTING_CHECK("-8.380923438e+04", ==, sprintf_, buffer, "%.9Le",
                   -83809.234375l);
...
PRINTF_TEST_CASE(integer_types)
{
    ...
    PRINTING_CHECK("-9223372036854775807", ==, sprintf_, buffer, "%lli",
...
#if PRINTF_SUPPORT_LONG_LONG
    PRINTING_CHECK("281474976710656", ==, sprintf_, buffer, "%llu",
                   281474976710656LLU);
    PRINTING_CHECK("18446744073709551615", ==, sprintf_, buffer, "%llu",
                   18446744073709551615LLU);
#endif
    PRINTING_CHECK("2147483647", ==, sprintf_, buffer, "%zu",
                   (size_t)2147483647UL);
    PRINTING_CHECK("2147483647", ==, sprintf_, buffer, "%zd",
                   (size_t)2147483647UL);
    PRINTING_CHECK("-2147483647", ==, sprintf_, buffer, "%zi",
                   (ssize_t)-2147483647L);
...
#if PRINTF_SUPPORT_LONG_LONG
    PRINTING_CHECK("1234567891234567", ==, sprintf_, buffer, "%llx",
                   0x1234567891234567LLU);
#endif
    ...
    PRINTING_CHECK("4660", ==, sprintf_, buffer, "%hu",
                   (unsigned short)0x1234u);
    PRINTING_CHECK("Test100 65535", ==, sprintf_, buffer, "%s%hhi %hu",
                   mkstr("Test"), (char)100, (unsigned short)0xFFFF);
    PRINTING_CHECK("a", ==, sprintf_, buffer, "%tx", &buffer[10] - &buffer[0]);
    PRINTING_CHECK("-2147483647", ==, sprintf_, buffer, "%ji",
                   (intmax_t)-2147483647L);
}
...
PRINTF_TEST_CASE(types__non_standard_format)
{
    ...
    PRINTING_CHECK("101111000110000101001110", ==, sprintf_, buffer, "%lb",
                   12345678L);
}
...
PRINTF_TEST_CASE(pointer)
{
    ...
    CAPTURE_AND_PRINT(sprintf_, buffer, "%p-%p", (void*)0x12345678U,
                      (void*)0x7EDCBA98U);
    if (sizeof(void*) == 4U)
    {
...
{
    char buffer[base_buffer_size];
    PRINTING_CHECK("This", ==, sprintf_, buffer, "%.4s",
                   mkstr("This is a test"));
    ...
    PRINTING_CHECK("1234ab", ==, sprintf_, buffer, "%.4s%.2s", mkstr("123456"),
                   mkstr("abcdef"));
    PRINTING_CHECK("123", ==, sprintf_, buffer, "%.*s", 3, mkstr("123456"));

    DISABLE_WARNING_PUSH
    DISABLE_WARNING_PRINTF_FORMAT_OVERFLOW
    PRINTING_CHECK("(null)", ==, sprintf_, buffer, "%.*s", 3,
                   (const char*)NULL);
    DISABLE_WARNING_POP
}
...
PRINTF_TEST_CASE(buffer_length)
{
    ...
    CAPTURE_AND_PRINT_WITH_RETVAL(ret, snprintf_, nullptr, 10, "%s",
                                  mkstr("Test"));
    CHECK(ret == 4);
    CAPTURE_AND_PRINT_WITH_RETVAL(ret, snprintf_, nullptr, (size_t)0, "%s",
                                  mkstr("Test"));
    CHECK(ret == 4);

    buffer[0] = (char)0xA5;
    CAPTURE_AND_PRINT_WITH_RETVAL(ret, snprintf_, buffer, (size_t)0, "%s",
                                  mkstr("Test"));
    CHECK(buffer[0] == (char)0xA5);
    CHECK(ret == 4);

    buffer[0] = (char)0xCC;
    CAPTURE_AND_PRINT_WITH_RETVAL(ret, snprintf_, buffer, 1, "%s",
                                  mkstr("Test"));
    CHECK(buffer[0] == '\0');
    PRINTING_CHECK_WITH_BUF_SIZE("H", ==, snprintf_, buffer, 2, "%s",
                                 mkstr("Hello"));

    DISABLE_WARNING_PUSH
    DISABLE_WARNING_PRINTF_FORMAT_OVERFLOW
    CAPTURE_AND_PRINT_WITH_RETVAL(ret, snprintf_, buffer, 2, "%s",
                                  (const char*)NULL);
    CHECK(!strcmp(buffer, "("));
    DISABLE_WARNING_POP
}
...
PRINTF_TEST_CASE(extremal_signed_integer_values)
{
    ...
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%hhd",
                   std::numeric_limits<char>::max());

    std::sprintf(expected, "%hd", std::numeric_limits<short int>::max());
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%hd",
    ...
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%d",
    ...
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%ld",
    ...
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%lld",
...
PRINTF_TEST_CASE(extremal_unsigned_integer_values)
{
    ...
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%hhu",
                   std::numeric_limits<char unsigned>::max());

    std::sprintf(expected, "%hu", std::numeric_limits<short unsigned>::max());
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%hu",
                   std::numeric_limits<short unsigned>::max());

    std::sprintf(expected, "%u", std::numeric_limits<unsigned>::max());
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%u",
                   std::numeric_limits<unsigned>::max());

    std::sprintf(expected, "%lu", std::numeric_limits<long unsigned>::max());
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%lu",
                   std::numeric_limits<long unsigned>::max());

#if PRINTF_SUPPORT_LONG_LONG
    std::sprintf(expected, "%llu",
                 std::numeric_limits<long long unsigned>::max());
    PRINTING_CHECK(expected, ==, sprintf_, buffer, "%llu",
                   std::numeric_limits<long long unsigned>::max());
#endif
}
